...
Before any other work in this repo (or any KHub project), follow the **AI Session Continuity
Standard**:
...
they never self-approve. Only the Supervisor (David) fills the Supervisor Review section.
See `docs/AI-SESSION-CONTINUITY-STANDARD.md`.
