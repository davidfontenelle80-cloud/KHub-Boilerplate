...
Every KHub project — this one included — follows the **AI Session Continuity Standard** so
that work never gets lost when an AI session ends (context runs out, a usage limit hits, or a
...
**never self-approve**. The **Supervisor** (David) owns architecture, sequencing, planning,
approvals, roadmap, and governance, and is the only one who writes the **Supervisor Review**
section of `ACTIVE_TASK.md`. Full detail in [`CONTRIBUTING_AI.md`](CONTRIBUTING_AI.md).
