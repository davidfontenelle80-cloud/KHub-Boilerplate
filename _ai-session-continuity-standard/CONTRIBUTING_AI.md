...
> change anything. These rules are binding on every AI worker in this project.
>
> _Template note:_ replace `<SUPERVISOR NAME>` below with this project's Supervisor, and
> delete this note.
...
**Supervisor:** `<SUPERVISOR NAME>`. **Workers:** AI sessions and any human doing
implementation work under the Supervisor's direction.
